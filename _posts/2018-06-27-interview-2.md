...
-垂直居中：
参考：(https://jscode.me/t/topic/1936)
...
1em是一个字的大小，而rem是根元素的font-size，当做手机端适配时1 rem == html font-size == viewport width ，所以我们需要用js根据手机屏幕的大小动态调整rem,
rem单位可以与其他单位同时存在，在 SCSS 里使用 PX2REM可以实现px 自动变 rem。

## 7.display:none与visibility:hidden的区别是什么？
